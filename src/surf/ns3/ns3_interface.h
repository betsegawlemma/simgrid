...
// Ecofen related declaration
XBT_PUBLIC(void) ecofen_init_basic_model(double idlePower, double byteEnergy);
XBT_PUBLIC(void) ecofen_init_linear_model(double idlePower);
XBT_PUBLIC(void) ecofen_init_log(double logTimeInterval, double logEndTime);
